...
function buildUserPrompt(params) {
  ...
  return [
    ...
    '',
    'Break the longer H2 sections down with H3 subheadings written as markdown',
    '"### Subheading" — at least two H2 sections must carry two or more H3s each.',
    'The contents list renders H2 and H3 at different weights, so the two levels',
    'are what give it a readable shape; an article that is all H2 comes out as a',
    'flat list. Use H3 for the distinct points inside a section, not to restate',
    'the H2 above it. Do not go deeper than H3, and never skip a level by putting',
    'an H3 before the first H2.',
    '',
